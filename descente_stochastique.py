        ...
        for epoch in range(self.max_iterations):
            if data is not None:
                ...
                for i in range(0, len(data), self.batch_size):
                    mini_batch = data[i:min(i + self.batch_size,
                                            len(data))]  # au cas où le dernier batch est plus petit
                    ...
                    current_point = self.update(current_point,
                                                current_gradient)
